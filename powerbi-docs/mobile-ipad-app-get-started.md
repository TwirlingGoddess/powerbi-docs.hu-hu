...
> [!NOTE]
> Az iPaden legalább az iOS 10-s verziójának kell futnia. 
> 
> 
...
1. Koppintson a globális navigációs gombra ![Globális navigáció gomb](media/mobile-ipad-app-get-started/power-bi-iphone-global-nav-button.png) a bal felső sarokban, majd koppintson a Beállítások ikonra ![Beállítások ikon](media/mobile-ipad-app-get-started/power-bi-ios-settings-gear.png).
...
* Koppintson a jobb felső sarokban található nagyító ikonra ![Keresés ikon](media/mobile-ipad-app-get-started/power-bi-ipad-search-icon.png), majd írja be a keresendő kifejezést.
