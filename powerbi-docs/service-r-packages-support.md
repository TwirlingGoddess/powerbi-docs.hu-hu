...
A következő bekezdések ábécérendben sorolják fel a Power BI-ban támogatott és nem támogatott R-csomagokat. Az R Power BI-beli használatáról az [R-vizualizációk](visuals/service-r-visuals.md) című cikkben talál további információt.

## <a name="request-support-for-a-new-r-package"></a>Új R-csomag támogatásának kérelmezése
A **Power BI szolgáltatás** által támogatott R-csomagok megtalálhatók a következő bekezdés **Támogatott csomagok** listájában. Ha a listában nem szereplő R-csomaghoz kíván támogatást kérni, akkor a kérelmét e-mailben küldheti el az [R a Power BI-ban visszajelzéseket kezelő csapatnak](mailto:rinpbifb@microsoft.com).
...
## <a name="r-packages-that-are-supported-in-power-bi"></a>A Power BI-ban támogatott R-csomagok
Az alábbi táblázat a Power BI szolgáltatás által **támogatott** csomagokat sorolja fel.


|        Csomag        |   Verzió   |                                   Hivatkozás                                   |
|-----------------------|-------------|--------------------------------------------------------------------------|
...
|osztály| 7.3-14| https://cran.r-project.org/web/packages/class/index.html|
|osztály| 7.3-14| https://cran.r-project.org/web/packages/class/index.html|
...
|cluster| clickstream| https://cran.r-project.org/web/packages/cluster/index.html|
|cluster| clickstream| https://cran.r-project.org/web/packages/cluster/index.html|
|cluster| CRAN| NA|
...
|adathalmazok| 3.4.1| NA|
|dátum| 1.2-37| https://cran.r-project.org/web/packages/date/index.html|
...
|Képlet| 1.2-2| https://cran.r-project.org/web/packages/Formula/index.html|
...
|gistr| 0.19.0| https://cran.r-project.org/web/packages/git2r/index.html|
...
|Grafikák| 3.4.1| NA|
|Grafikák| grDevices| party (>= 1.1-0)|
|Grafikák| CRAN| NA|
|grDevices| 3.4.1| NA|
...
|gridExtra| Mátrix| glue|
|gridExtra (>= 2.0.0)| Grafikák| reshape2|
...
|laekeni| 0.4.6| https://cran.r-project.org/web/packages/laeken/index.html|
...
|Mátrix| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html|
|Mátrix| 1.2-10| https://cran.r-project.org/web/packages/Matrix/index.html|
|matrixcalc| coda| NA|
...
|quanteda| 0.4-10| https://cran.r-project.org/web/packages/quantmod/index.html|
...
|jelentések| 0.1.4| https://cran.r-project.org/web/packages/reports/index.html|
...
|rngtools (> = 1.2.3)| cluster| Grafikák|
...
|fatérkép| 2.4-2| https://cran.r-project.org/web/packages/treemap/index.html|
...
## <a name="r-scripts-that-are-not-supported-in-power-bi"></a>A Power BI-ban nem támogatott R-csomagok
Az alábbi táblázat a Power BI szolgáltatás által **nem támogatott** csomagokat sorolja fel.

| Csomag | Kérelem kelte | Ok |
| --- | --- | --- |
| RgoogleMaps |10/05/2016 |Hálózati blokkolás |
| mailR |10/03/2016 |Hálózati blokkolás |
| RevoScaleR |8/30/2016 |csak a Microsoft R Server részeként szerezhető be |

## <a name="next-steps"></a>További lépések
Az R Power BI-beli használatával kapcsolatban az alábbi cikkekben találhat további információt:

* [R-vizualizációk létrehozása a Power BI szolgáltatásban](visuals/service-r-visuals.md)
* [Power BI-vizualizációk létrehozása R használatával](desktop-r-visuals.md)
* [R-parancsfájlok futtatása a Power BI Desktopban](desktop-r-scripts.md)
* [Az R használata a lekérdezésszerkesztőben](desktop-r-in-query-editor.md)
