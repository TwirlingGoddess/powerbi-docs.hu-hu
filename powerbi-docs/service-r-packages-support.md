...
A következő bekezdések ábécérendben sorolják fel a Power BI-ban támogatott és nem támogatott R-csomagokat. Az R Power BI-beli használatáról az [R-vizualizációk](service-r-visuals.md) című cikkben talál további információt.
...
* [R-vizualizációk létrehozása a Power BI szolgáltatásban](service-r-visuals.md)
