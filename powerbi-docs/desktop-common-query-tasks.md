...
Az első adatkapcsolat egy Excel-munkafüzet. A másik egy webes forrásanyag (ezt a Power BI Desktop egyéb súgói is alkalmazzák), amely a következő helyen érhető el:
