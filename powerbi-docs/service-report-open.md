...
1. Válassza ki egy jelentés nevét, és nyissa meg Olvasó nézetben.  
   
    ![](media/service-report-open/power-bi-reading-view.png)
1. [Az Olvasó nézetben sokféle lehetősége van](service-reading-view-and-editing-view.md).  Ez egy többoldalas jelentésminta, feltárásához válassza ki az egyes oldalakat a jelentésvászon alján. 
