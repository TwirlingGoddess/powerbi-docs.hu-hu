...
- [Business Applications ‘18 tavaszi kiadási megjegyzések](https://aka.ms/bagspring2018releasenotes_internal) a Dynamics 365-től: Üzleti alkalmazásaink legújabb frissítései és új funkciók alkalmazásai és bővítményei platformunkon történő fejlesztéséhez. 
...
* Private Preview verzió: Streamelési csempék létrehozásához használható Power BI-streamelési adatkészletek készítése az [Azure Stream Analytics](https://powerbi.microsoft.com/blog/announcing-private-preview-of-azure-stream-analytics-outputting-to-power-bi-streaming-datasets/) szolgáltatással.
...
* Az adatméret korlátját 1 GB-ra emeltük: Mind az Excel-munkafüzetek, mind a Power BI Desktop-fájlok esetében a fájlméret korlátja 1 GB-ra nőtt.
...
* Továbbfejlesztett letöltés: Az Elemzés az Excelben funkció frissítéseit könnyen letöltheti egy új párbeszédpanelen.
...
A részletekről a [Power BI-csapat blogján](https://powerbi.microsoft.com/blog/power-bi-service-march-update-part-two/) olvashat.
...
* Vizualizációk fejlesztései:
  ...
  2. új vizualizáció: Halmozott területdiagram
...
* A Desktop adatkapcsolati fejlesztései
  ...
  4. „Adatok megadása”: táblázat létrehozása adatok beillesztésével vagy beírásával
  5. DirectQuery-fejlesztések: teljesítménybeli javulás a T-SQL és az SAP HANA minden adattípusának támogatása eredményeképp.
  6. ODBC-összekötő: az adatforrásnevek és a felhasználói adatforrásnevek kiválasztásának támogatása
  7. CSV-összekötő: oszlophatároló megadása a Forrás párbeszédpanelen
...
* Interaktív Power BI-vásárlási folyamat.
...
* A Power BI-ban mostantól megfigyelheti, elemezheti és [megjelenítheti az Adobe Analytics-adatait](http://blogs.msdn.com/b/powerbi/archive/2015/08/25/exploring-your-adobe-analytics-data-in-power-bi.aspx). Egy használatra kész tartalomcsomaggal csatlakozhat az adatokhoz és azonnal elemezheti őket. További információkért látogasson el a [Power BI-hoz készült Adobe Analytics tartalomcsomag súgóoldalára](service-connect-to-adobe-analytics.md).
...
* A Power BI szolgáltatással megfigyelheti és feltárhatja az adatokat a [MailChimp API-k segítségével](http://blogs.msdn.com/b/powerbi/archive/2015/06/09/user-power-bi-to-monitor-and-visualize-your-mailchimp-data.aspx), amelyek egy használatra kész elemzési tartalomkészletet nyújtanak. A MailChimp-forgatókönyvhöz összeválogatott irányítópultok, jelentések és adatkészletek segítségével könnyen hozzáférhet az adatokhoz, például a Legsikeresebb kampányokhoz vagy Az összes megnyitott elemhez a hét napjai szerint rendezve. További részleteket az első lépésekről a Power BI MailChimp tartalomcsomag [dokumentációjában](service-connect-to-mailchimp.md) találhat.
...
* A Power BI legutóbbi frissítésével csatlakozhat az **SQL Database naplózási szolgáltatása** által naplózott adatokhoz egy használatra kész jelentéskészlettel és egy testreszabott irányítópulttal. Ezzel a tartalomcsomaggal könnyen azonosíthat gyanús eseményeket, valamint szokatlan tevékenységeket és trendeket a jelentéshez létrehozott adatkészlet alapján. További információt ebben a [blogbejegyzésben](http://blogs.msdn.com/b/powerbi/archive/2015/05/14/monitor-your-azure-sql-database-auditing-activity-with-power-bi.aspx) és a [dokumentációban](service-connect-to-azure-sql-database-auditing.md) találhat.
...
* Mostantól az új tartalomcsomagunkkal megjelenítheti és feltárhatja a **Microsoft Dynamics Marketing-adatait**. További információt ebben a [blogbejegyzésben](http://blogs.msdn.com/b/powerbi/archive/2015/04/23/monitor-and-explore-your-microsoft-dynamics-marketing-data-with-power-bi.aspx) és a [dokumentációban](service-connect-to-microsoft-dynamics-marketing.md) találhat.

**2015. április 15.**

* Mostantól az új tartalomcsomagunkkal megjelenítheti és feltárhatja a **Google Analytics-adatait**. A Google Analytics tartalomcsomag egy irányítópultot, egy jelentést és egy adatkészletet tartalmaz, amelyekkel az utóbbi 6 hónap webhelyhasználati adatait elemezheti. További információt ebben a [blogbejegyzésben](http://blogs.msdn.com/b/powerbi/archive/2015/04/15/visualize-and-explore-your-google-analytics-data-with-power-bi.aspx) és a [dokumentációban](service-connect-to-google-analytics.md) találhat.
