...
2. Keresse meg a törölni kívánt irányítópultot, és kattintson a Törlés ikonra ![törlés ikon](./media/end-user-delete/power-bi-delete-icon.png).

    ![videó](./media/end-user-delete/power-bi-delete-dash.gif)
...
2. Keresse meg a törölni kívánt jelentést, és kattintson a Törlés ikonra   ![törlés ikon](./media/end-user-delete/power-bi-delete-icon.png).   

    ![a munkaterület jelentések lapja](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Erősítse meg a törlési szándékát.

   ![Jelentés törlése párbeszédpanel](./media/end-user-delete/power-bi-delete-report.png)
...
2. Keresse meg a törölni kívánt munkafüzet, és kattintson a Törlés ![törlés ikon](./media/end-user-delete/power-bi-delete-report2.png) ikonra.

    ![Munkafüzetek lap](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Erősítse meg a törlési szándékát.

   ![Munkafüzet eltávolítása párbeszédpanel](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Keresse meg a törölni kívánt adatkészletet, és kattintson a három pontra (...).  
    ...
    ![Adatkészletek lap](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. A legördülő listából válassza a **Törlés** lehetőséget.

   ![három pont menü](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Erősítse meg a törlési szándékát.

   ![Irányítópult törlése párbeszédpanel](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. A bal oldali navigációs panelen válassza a **Munkaterületek** elemet
    ...
    ![Alkalmazás munkaterületei](./media/end-user-delete/power-bi-delete-workspace.png)
2. Kattintson a törölni kívánt munkaterülettől jobbra található három pontra (...), és válassza a **Munkaterület szerkesztése** lehetőséget.
   ...
   ![három pont menü > Munkaterület szerkesztése](./media/end-user-delete/power-bi-edit-workspace.png)
3. A **Munkaterület szerkesztése** ablakban válassza a **Munkaterület törlése** > **Törlés** lehetőséget.

    ![munkaterület törlése](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. A jobb felső sarokban kattintson a három pontra (...), és válassza a **Kilépés a munkaterületről** > **Kilépés** lehetőséget.
      ...
      ![kilépés a munkaterületből](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Vigye a mutatót a törölni kívánt alkalmazás fölé, majd kattintson a Törlés ![](./media/end-user-delete/power-bi-delete-report2.png) ikonra.

   ![alkalmazások kiválasztása](./media/end-user-delete/power-bi-delete-app.png)

   Ha véletlenül távolít el egy alkalmazást, számos módon visszaszerezheti.  Megkérheti az alkalmazás létrehozóját, hogy küldje el újra, megkeresheti a hivatkozást tartalmazó eredeti e-mailt, ellenőrizheti az [Értesítési központban](end-user-notification-center.md), hogy listázva van-e még az alkalmazás, vagy ellenőrizheti a szervezet [AppSource](end-user-apps.md)-át.
...
* [A Kiemelt irányítópult eltávolítása](end-user-featured.md#change-the-featured-dashboard)
* [Egy irányítópult eltávolítása (kedvencnek jelölés visszavonása)](end-user-favorite.md)
* [Jelentésoldal törlése](end-user-delete.md)
* [Irányítópult csempe törlése](../service-dashboard-edit-tile.md)
* [Jelentés-vizualizáció törlése](end-user-delete.md)
