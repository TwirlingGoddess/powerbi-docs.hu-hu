...
A Szerkesztési nézet csak a jelentés létrehozói számára, vagy azok számára érhető el, akik egy [alkalmazás-munkaterület tagjaként vagy rendszergazdájaként a jelentés társtulajdonosai](end-user-create-apps.md).
...
| [Jelentés törlése](end-user-delete.md) | Nem  | Igen |
|**Jelentés oldala** |
...
| [Jelentésoldal törlése](end-user-delete.md) | nem | igen |
...
| [Vizualizáció, szövegmező vagy alakzat törlése](end-user-delete.md)| Nem | Igen |
