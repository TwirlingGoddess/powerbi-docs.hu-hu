...
* Ha az irányítópultnak Ön a tulajdonosa, eltávolíthatja. Ha megosztotta az irányítópultot a kollégáival, és törli a saját Power BI-munkaterületéről, azzal a kollégák Power BI-munkaterületéről is törli.
...
Az adatkészletek törölhetők. Egy adatkészlet törlésével azonban törli az összes olyan jelentést és irányítópult-csempét is, amely ennek az adatkészletnek az adatait tartalmazza.
...
2. Vigye a mutatót a törölni kívánt alkalmazás fölé, majd kattintson a Törlés ![](media/service-delete/power-bi-delete-report2.png) ikonra.
   ...
   Ha véletlenül távolít el egy alkalmazást, számos módon visszaszerezheti.  Megkérheti az alkalmazás létrehozóját, hogy küldje el újra, megkeresheti a hivatkozást tartalmazó eredeti e-mailt, ellenőrizheti az Értesítések központban, hogy listázva van-e még az alkalmazás, vagy ellenőrizheti a szervezet AppSource-át.
